...
class LoginsControllerTest < ActionController::TestCase
  ...
  test "should create login" do
    assert_difference('Login.count') do
      post :create, login: { password: @login.password, phone_no: @login.phone_no, user_name: @login.user_name }
    end
  ...
  test "should update login" do
    patch :update, id: @login, login: { password: @login.password, phone_no: @login.phone_no, user_name: @login.user_name }
    assert_redirected_to login_path(assigns(:login))
  end
