...
class SignupsControllerTest < ActionController::TestCase
  ...
  test "should create signup" do
    assert_difference('Signup.count') do
      post :create, signup: { email: @signup.email, password: @signup.password, phone_no: @signup.phone_no, user_name: @signup.user_name }
    end
  ...
  test "should update signup" do
    patch :update, id: @signup, signup: { email: @signup.email, password: @signup.password, phone_no: @signup.phone_no, user_name: @signup.user_name }
    assert_redirected_to signup_path(assigns(:signup))
  end
